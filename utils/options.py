...
def args_parser():
    ...
    parser.add_argument('--iterations', type=int, default=1, help="iterations of training")
    parser.add_argument('--type_exp', type=str, default='base', help="type of experiment ('all', 'base', 'cluster', 'lsh-cluster')")
    ...
    parser.add_argument('--plot_std', action='store_true', help='whether plot std or not')
    parser.add_argument('--multi_plot_case', type=int, default=0, help='...')
    parser.add_argument('--code_dim', type=int, default=512, help="lsh code dimension")
